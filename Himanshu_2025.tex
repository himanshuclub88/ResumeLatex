...
\section{Experience}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Applied \textbf{Spark performance tuning techniques} (caching, partitioning, broadcast joins), reducing processing time by \textbf{20\%} for \textbf{2M+ daily records} across \textbf{Hadoop and Azure environments}.}
  \resumeItemListEnd
